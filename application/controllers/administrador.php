...
class Administrador extends Private_Controller {
    ...
    public function index($page = 'index')
    {
        ...
        $_usuarios = $this->Usuario_model->get_all();
        ...
        $this->smarty->assign('_usuarios', $_usuarios);
        $this->smarty->view( 'administrador/index.tpl', $data );
    }

    public function perfiles($page = 'index')
    {
        $url = $this->config->base_url();
        $user = $this->session->userdata("logged_user");
        $rol = $this->session->userdata("user_rol");
        ...
        $this->smarty->view( 'administrador/perfiles.tpl', $data );
    }
