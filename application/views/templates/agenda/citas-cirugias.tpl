...
{block name="scripts" append}
   ...
   <script src="{$url}assets/plugins/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
    ...
    function consultarAgenda(year, month, day, especialista_id){
        $.ajax({
                type: "POST",
                url: "{$url}agenda/agendaCirugia/"+year+"/"+month+"/"+day+"/"+especialista_id,
    ...
    function agendarPaciente(especialista, paciente, fechahora, callback){
        ...
        $.ajax({
            type: "POST",
            url: "{$url}agenda/programarCirugia/"+especialista+"/"+paciente+"/"+fechahora,
            data: especialista,
            dataType: "text",  
            cache:false,
            success: 
    ...
    function vincularPersonal(cita_id){
        ...
        $.ajax({
                type: "POST",
                url: "{$url}agenda/apoyoCirugia/"+cita_id,
                data: cita_id,
                dataType: "text",  
                cache:false,
                success: 
