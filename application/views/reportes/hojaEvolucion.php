...
// HISTORIA CLINICA GENERAL
    ...
    $pdf->SetFillColor(216, 216, 216);
    $pdf->Cell(120, 6, '2. EVOLUCIONES', 1, 1, '', 1);
    $pdf->Ln(4);
    ...
    if(count($evoluciones) > 0){                
            ...
            foreach ($evoluciones as $evolucion){
                $tblReporte .= "<tr>"
                                ."<td>".substr($evolucion['fecha'], 0, 4)."</td>"
                                ."<td>".substr($evolucion['fecha'], 5, 2)."</td>"
                                ."<td>".substr($evolucion['fecha'], 8, 2)."</td>"
                                ."<td colspan=\"7\">".$evolucion['detalle']."</td>"
                            . "</tr>";
                $j++;
            }
    }
