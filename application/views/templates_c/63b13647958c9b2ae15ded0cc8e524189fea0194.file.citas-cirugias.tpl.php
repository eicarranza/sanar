<?php /* Smarty version Smarty-3.1.15, created on 2014-06-16 00:13:55
         compiled from "application\views\templates\agenda\citas-cirugias.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11279533ce70f695c73-03978492%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '63b13647958c9b2ae15ded0cc8e524189fea0194' => 
    array (
      0 => 'application\\views\\templates\\agenda\\citas-cirugias.tpl',
      1 => 1402892032,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '11279533ce70f695c73-03978492',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.15',
  'unifunc' => 'content_533ce70fab7d81_96503233',
  'variables' => 
  array (
    'title' => 0,
    'url' => 0,
...
<?php if ($_valid && !is_callable('content_533ce70fab7d81_96503233')) {function content_533ce70fab7d81_96503233($_smarty_tpl) {?><!DOCTYPE html>
<!-- 
        ...
        <div class="col-md-12">
           <div class="portlet box blue calendar">
              <div class="portlet-title">
                 <div class="caption"><i class="icon-reorder"></i>Agenda de Cirugía</div>
                 <div class="actions">
                     <a id="btn-nueva-cita" href="#cita" class="btn green">
                         <i class="icon-pencil"></i> Programar cirugía
                     </a>
                 </div>
              </div>
...
"><?php echo $_smarty_tpl->tpl_vars['gs']->value['nombres'];?>
 <?php echo $_smarty_tpl->tpl_vars['gs']->value['apellidos'];?>
    ...
    <div id="responsive" class="modal fade" tabindex="-1" data-width="760">
     ...
     <div id="facturacion" class="modal fade" tabindex="-1" data-width="500">
        <div class="modal-content">
            <div class="modal-header">
               <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
    ...
    <!-- MODAL PARA VINCULAR PROFESIONALES DE LA SALUD -->
     <div id="profesionales" class="modal fade" tabindex="-1" data-width="500">
        <div class="modal-content">
            <div class="modal-header">
               <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
               <h4 class="modal-title">Vincular Profesionales de la Salud</h4>
            </div>
            <div id="dv_profesionales" class="modal-body">

            </div>
        </div>
        
    </div>
    <!-- FIN MODAL PARA VINCULAR PROFESIONALES DE LA SALUD -->
     ...
     <div id="cita" class="modal fade" tabindex="-1">
        <div class="modal-header">
           <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
           <h4 class="modal-title">Programar cirugía</h4>
        </div>
...
">
       ...
       <div class="modal-footer">
           <button type="button" data-dismiss="modal" class="btn btn-default">Cerrar</button>
           <button type="button" id="btn-programar-cirugia" data-dismiss="modal" class="btn blue">Guardar cambios</button>
       </div>
    </div>
...
assets/scripts/form-components.js"></script>     
    ...
    jQuery(document).ready(function() {
        ...
        $("#mdl_citaIdentificacion").keypress(function(e) {
            if(e.which == 13){
                var paciente = $( '#mdl_citaIdentificacion' ).val();
                pacienteFueraHorario(paciente);
            }
        ...
        $("#btn-programar-cirugia").click(function () {
            var especialista = $('#especialista').attr('value');
        ...
        if(paciente != ""){
                agendarPaciente(especialista, paciente, fecha, function(url){
                    if(url == "false"){
                        alert("No es posible programar la cirugía. El doctor ya tiene agendada una cita médica.");
                    }
                    consultar();
                });
            }
        ...
        $("#btn-profesionales-guardar").click(function () {
            set_profesionales();
           return false;
        });
...
agenda/agendaCirugia/"+year+"/"+month+"/"+day+"/"+especialista_id,
...
pacientes/nuevoModal/"+paciente+"/"+horaini,
    ...
    function agendarPaciente(especialista, paciente, fechahora, callback){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo $_smarty_tpl->tpl_vars['url']->value;?>
agenda/programarCirugia/"+especialista+"/"+paciente+"/"+fechahora,
            data: especialista,
            dataType: "text",  
            cache:false,
            success: 
...
agenda/setFacturacion', postData, function(data){
    ...
    function vincularPersonal(cita_id){
        
        $.ajax({
                type: "POST",
                url: "<?php echo $_smarty_tpl->tpl_vars['url']->value;?>
agenda/apoyoCirugia/"+cita_id,
                data: cita_id,
                dataType: "text",  
                cache:false,
                success: 
                     function(data){
                        $('#dv_profesionales').empty();
                        $('#dv_profesionales').html(data);
                     }
        });
        
        $("#profesionales").modal('show');
        
       return false;
    }
    
    function set_profesionales(){
        /*
         * AGREGAR EL CÓDIGO PARA GUARDAR LOS PROFESIONALES DE LA SALUD
         * SE PUEDE TOMAR DE REFERENCIA EL CÓDIGO DE FACTURACIÓN
         */
        $("#profesionales").modal('hide');
